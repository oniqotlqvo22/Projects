...
final class DetailsScreenViewModelTests: XCTestCase {
    ...
    func test_DetailsView_withTVSeries_HappyCase() {
        ...
        viewModel = MoviesDetailsViewModel(mediaType: .tvSeries, mediaID: id, coordinator: movieDetailsCoordinator, apiService: mockMovieDBService)
    ...
    func test_DetailsView_withMovies_HappyCase() {
        ...
        let id = 10
        movieDetailsCoordinator = MovieDetailsViewCoordinator(navController: navController, id: id)
        viewModel = MoviesDetailsViewModel(mediaType: .movies, mediaID: id, coordinator: movieDetailsCoordinator, apiService: mockMovieDBService)
